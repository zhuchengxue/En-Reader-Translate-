/* Cloudflare Pages Function: 内置翻译代理，部署后所有访客默认可用。
 * 路由：POST /api/translate  ->  { translatedText }
 * 逻辑与 worker/index.js 一致：优先 Google(gtx)，失败兜底 Lingva。
 * 本地开发无此端点，应用会自动回退到 Lingva / MyMemory，不影响本地使用。
 */
const cors = {
...
export async function onRequest(context) {
  ...
  /* Google 从边缘偶发 429/空返回，兜底 Lingva（同样代理 Google） */
  try {
