...
const Settings = (() => {
  ...
  const defaults = { theme: 'light', fontSize: 18, lineHeight: 1.9, marginSize: 'medium', clickMode: 'both', pageMode: 'single', pageAnim: 'slide', translateProxy: '', lastBookId: '', syncToken: '', dictLang: 'both' };
  let cache = null;
  return {
    get() {
      if (!cache) {
