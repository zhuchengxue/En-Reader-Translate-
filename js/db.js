...
const Settings = (() => {
  ...
  const defaults = { theme: 'light', fontSize: 18, lineHeight: 1.9, marginSize: 'medium', clickMode: 'both', pageMode: 'single', pageAnim: 'slide', translateProxy: '', lastBookId: '', dictLang: 'both', persistLookup: false, autoResumeBook: true };
  let cache = null;
  return {
    get() {
      if (!cache) {
